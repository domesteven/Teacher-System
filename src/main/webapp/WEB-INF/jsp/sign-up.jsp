  ...
  <!--<![endif]-->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="${pageContext.request.contextPath}/register.action" name="registerForm" method="post">
               <div class="form-group">
                ...
                <div class="form-group">
                    <label>密码</label>
                    <input name="password" type="password" class="form-control span12">
                </div>
                <div class="form-group">
                    <label>Email</label>
    ...
    <p><a href="${pageContext.request.contextPath}/goLoginPage.action" style="font-size: .75em; margin-top: .25em;">已有账号，去登陆！</a></p>
</div>
