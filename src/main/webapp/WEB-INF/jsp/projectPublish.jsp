	...
	<script type="text/javascript">
        ...
        function searchByName(){
        	...
        	if(time != undefined && time != ""){
        		time += "-01-01";
        		url =url+ "&publishTime="+encodeURI(encodeURI(time));
        	}
...
.navbar-default .navbar-brand,.navbar-default .navbar-brand:hover {
    ...
    <li><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> 教学<i class="fa fa-collapse"></i></a></li>        <li><ul class="premium-menu nav nav-list collapse">
        ...
        <li><ul class="accounts-menu nav nav-list collapse in">
            <li class="active"><a href="${pageContext.request.contextPath}/goProjectPublish.action"><span class="fa fa-caret-right"></span> 发表文献</a></li>
	...
	<div class="content">
		<div class="btn-toolbar list-toolbar">
			...
			<label class="seaName">刊物名称:</label>
			<c:if test='${openAuthor == "true"}'>
		...
		<div class="modal-dialog">
			...
			<div class="modal-header">
				...
				<div class="modal-body" >
					<table class="table" >
				<thead>
				<form id="form2" action="${pageContext.request.contextPath}/uploadAttach6.action" method="post" enctype="multipart/form-data">
					<tr>
