...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
          ...
          <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
              ...
              <ul class="dropdown-menu">
                <li><a href="${pageContext.request.contextPath}/goPersonInfoPage.action">账户</a></li>
                <li class="divider"></li>
                ...
                <li class="divider"></li>
                <li><a tabindex="-1" href="${pageContext.request.contextPath}/loginOut.action">登出</a></li>
              </ul>
            </li>
          </ul>
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            ...
            <li ><a href="${pageContext.request.contextPath}/goUserPage.action"><span class="fa fa-caret-right"></span> User Profile</a></li>
    ...
    <li data-popover="true" data-content="Items in this group require a <strong><a href='http://portnine.com/bootstrap-themes/aircraft' target='blank'>premium license</a><strong>." rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> 教学<i class="fa fa-collapse"></i></a></li>
        ...
        <li><a href="#" data-target=".legal-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-legal"></i>项目<i class="fa fa-collapse"></i></a></li>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="knob-container">
                                <input class="knob" data-width="200" data-min="0" data-max="3000" data-displayPrevious="true" value="2100" data-fgColor="#92A3C2" data-readOnly=true;>
