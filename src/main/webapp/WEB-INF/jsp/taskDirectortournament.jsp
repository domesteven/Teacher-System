...
<body class=" theme-blue">
	...
	<script type="text/javascript">
        ...
        function delRecord(){
        	...
        	$.ajax({
                type: "post",
                url: "${pageContext.request.contextPath}/delTaskDirectortournament.do", 
                data: {id:id},
                dataType: "json",
                success: function(data){
                	if(data.errcode == "-1"){
        ...
        function excel(){
        	var url = "${pageContext.request.contextPath}/TaskDirectortournamentExcel.action";
        	var name = $("#searchName").val();
        	if(name != null && name != ""){
        		url += "?name="+encodeURI(encodeURI(name));
        	}else{
...
.navbar-default .navbar-brand,.navbar-default .navbar-brand:hover {
    ...
    <li><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> 教学<i class="fa fa-collapse"></i></a></li>        <li><ul class="premium-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/goTaskDirectortournament.action"><span class="fa fa-caret-right"></span> 学科竞赛指导任务</a></li>
