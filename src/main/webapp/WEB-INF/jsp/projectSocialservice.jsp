...
<body class=" theme-blue">
	...
	<script type="text/javascript">
		...
		var baseurl  = "${pageContext.request.contextPath}/goProjectSocialservice.action";
        $(function() {
        ...
        function delRecord(){
        	...
        	$.ajax({
                type: "post",
                url: "${pageContext.request.contextPath}/delProjectSocialservice.do", 
                data: {id:id},
                dataType: "json",
        ...
        function insert(){
        	var id = $("#id").val();
        	if(id != null && id != ""){
        		$("#form1").attr('action',"${pageContext.request.contextPath}/editProjectSocialservice.action"); 
        	}
        	$("#form1").submit();
        }
        function reset(){
        ...
        function searchByName(){
        	...
        	if(time != undefined && time != ""){
        		time += "-01-01";
        		url =url+ "&startTime="+encodeURI(encodeURI(time));
        	}
        ...
        function editTaskInfo(id){
        	...
        	$.ajax({
                type: "post",
                url: "${pageContext.request.contextPath}/selectProjectSocialserviceById.action", 
                data: {id:id},
                dataType: "json",
                success: function(data){
                	if(data.errcode == "-1"){
...
.navbar-default .navbar-brand,.navbar-default .navbar-brand:hover {
    ...
    <li><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> 教学<i class="fa fa-collapse"></i></a></li>        <li><ul class="premium-menu nav nav-list collapse">
        ...
        <li><ul class="accounts-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/goProjectSocialservice.action"><span class="fa fa-caret-right"></span> 服务社会成果</a></li>
				...
				<tbody>
					...
					<c:forEach items="${list}" var="item">
						<tr>
							...
							<td>${item.member}</td>
							<td>${item.name}</td>
							<td>${item.serviceTime}天</td>
							<td>${item.money}</td>
							<td><fmt:formatDate value="${item.startTime}" type="date" pattern="yyyy-MM-dd"/></td>
		...
		<div class="modal-dialog" style="width: 700px;height:250px;">
			<div class="modal-content">
				...
				<div style="height:300px;width:500px,overflow:auto; ">
					<form id="form1" action="${pageContext.request.contextPath}/saveProjectSocialservice.action"
			...
			<table id="table1"
				...
				<tbody>
					<tr>
						...
						<td width="30%">服务企业名称或部门<font color="FF0000">*</font></td>
						<td width="500"><input id="companyName" name="companyName" type="text"
							value="" /></td>

					</tr>
					
					<tr>
						<td>成员<font color="FF0000">*</font></td>
						<td>
							<input id="member" name="member" type="text" /></td>
						

					</tr>
					<tr>
						<td>项目名称<font color="FF0000">*</font></td>
					...
					<tr>
						<td>服务时限<font color="FF0000">*</font></td>
						<td><input id="serviceTime" name="serviceTime"
							type="text" value="" />天</td>

					</tr>
					
					<tr>
						<td>经费<font color="FF0000">*</font></td>
					...
					<tr>
						<td>立项时间<font color="FF0000">*</font></td>
		...
		<div class="modal-dialog">
			...
			<div class="modal-header">
				...
				<div class="modal-body" >
					<table class="table" >
				<thead>
				<form id="form2" action="${pageContext.request.contextPath}/uploadAttach8.action" method="post" enctype="multipart/form-data">
					<tr>
