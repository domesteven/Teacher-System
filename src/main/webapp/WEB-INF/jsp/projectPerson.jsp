...
<body class=" theme-blue">
	...
	<script type="text/javascript">
		...
		var baseurl  = "${pageContext.request.contextPath}/goProjectPerson.action";
        $(function() {
        ...
        function delRecord(){
        	...
        	$.ajax({
                type: "post",
                url: "${pageContext.request.contextPath}/delProjectPerson.do", 
                data: {id:id},
                dataType: "json",
        ...
        function insert(){
        	var id = $("#id").val();
        	if(id != null && id != ""){
        		$("#form1").attr('action',"${pageContext.request.contextPath}/editProjectPerson.action"); 
        	}
        	$("#form1").submit();
        }
        function reset(){
        ...
        function editTaskInfo(id){
        	...
        	$.ajax({
                type: "post",
                url: "${pageContext.request.contextPath}/selectProjectPersonById.action", 
                data: {id:id},
                dataType: "json",
                success: function(data){
                	if(data.errcode == "-1"){
        ...
        function excel(){
        	var url = "${pageContext.request.contextPath}/ProjectPersonExcel.action";
        	var name = $("#searchName").val();
...
.navbar-default .navbar-brand,.navbar-default .navbar-brand:hover {
    ...
    <li><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i> 教学<i class="fa fa-collapse"></i></a></li>        <li><ul class="premium-menu nav nav-list collapse">
        ...
        <li><ul class="accounts-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/goProjectPerson.action"><span class="fa fa-caret-right"></span> 人才工程项目</a></li>
		...
		<div class="modal-dialog" style="width: 700px;height:250px;">
			<div class="modal-content">
				...
				<div style="height:300px;width:500px,overflow:auto; ">
					<form id="form1" action="${pageContext.request.contextPath}/saveProjectPerson.action"
			...
			<table id="table1"
				...
				<tbody>
					<tr>
						...
						<td width="30%">人才工程名称<font color="FF0000">*</font></td>
					...
					<tr>
						<td>人才工程开始时间<font color="FF0000">*</font></td>
		...
		<div class="modal-dialog">
			...
			<div class="modal-header">
				...
				<div class="modal-body" >
					<table class="table" >
				<thead>
				<form id="form2" action="${pageContext.request.contextPath}/uploadAttach7.action" method="post" enctype="multipart/form-data">
					<tr>
